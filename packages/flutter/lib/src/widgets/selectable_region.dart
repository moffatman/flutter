...
abstract class MultiSelectableSelectionContainerDelegate extends SelectionContainerDelegate with ChangeNotifier, Diagnosticable {
  ...
  SelectionResult _initSelection(SelectionEdgeUpdateEvent event, {required bool isEnd}) {
    ...
    final List<SelectionResult> results = selectables.toList(growable: false).map((Selectable child) => dispatchSelectionEventToChild(child, event)).toList(growable: false);
