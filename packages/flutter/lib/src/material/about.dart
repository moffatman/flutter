...
double _getGutterSize(BuildContext context) =>
    MediaQuery.of(context, MediaQueryAspect.width).size.width >= _materialGutterThreshold ? _wideGutterSize : _narrowGutterSize;
...
class _DetailView extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final double screenHeight = MediaQuery.of(context, MediaQueryAspect.height).size.height;
