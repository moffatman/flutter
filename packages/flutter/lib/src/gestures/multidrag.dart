...
abstract class MultiDragPointerState {
  ...
  void resolve(GestureDisposition disposition, [double bid = 1]) {
    _arenaEntry!.resolve(disposition, bid);
  }
...
class _ImmediatePointerState extends MultiDragPointerState {
  ...
  void checkForResolutionAfterMove() {
    assert(pendingDelta != null);
    resolve(GestureDisposition.accepted, pendingDelta!.distance / computeHitSlop(kind, gestureSettings));
...
class _HorizontalPointerState extends MultiDragPointerState {
  ...
  void checkForResolutionAfterMove() {
    assert(pendingDelta != null);
    resolve(GestureDisposition.accepted, pendingDelta!.dx.abs() / computeHitSlop(kind, gestureSettings));
  }
...
class _VerticalPointerState extends MultiDragPointerState {
  ...
  void checkForResolutionAfterMove() {
    assert(pendingDelta != null);
    resolve(GestureDisposition.accepted, pendingDelta!.dy.abs() / computeHitSlop(kind, gestureSettings));
  }
