...
class _CombiningGestureArenaEntry implements GestureArenaEntry {
  ...
  void resolve(GestureDisposition disposition, [double bid = 1]) {
    _combiner._resolve(_member, disposition, bid);
  }
}
...
class _CombiningGestureArenaMember extends GestureArenaMember {
  ...
  void _resolve(GestureArenaMember member, GestureDisposition disposition, [double bid = 1]) {
    if (_resolved)
      return;
    if (disposition == GestureDisposition.rejected) {
      ...
      if (_members.isEmpty)
        _entry!.resolve(disposition, bid);
    } else {
