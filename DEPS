...
vars = {
  ...
  'skia_revision': '36321960e4f4cb7bb0ff77d39a0f79c3b19e6c87',
  ...
  'dart_revision': '3d3cc452350d3dfeba472f5f605edfa93068bbe5',
  'dart_official_revision': 'a9b7bd4b0b323fcc1001fdfeef985d1484492c8c',
  ...
  'dart_boringssl_rev': '4ab431c063ebba1af33baea6838b74af08fdb71c',
...
deps = {
  ...
  'https:///github.com/moffatman/boringssl.git' + '@' + Var('dart_boringssl_rev'),
  ...
  'engine/src/flutter/third_party/dart':
   'https:///github.com/moffatman/dart-sdk.git' + '@' + Var('dart_revision'),
    ...
    'packages': [
      {
        ...
        'version': 'git_revision:'+Var('dart_official_revision')
      }
    ],
    'dep_type': 'cipd',
